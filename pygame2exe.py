...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "vShooter.py"
 
        #Name of program
        self.project_name = "Scrolling Shooter"
        ...
        #Auhor of program
        self.author_name = "Stephen Hollibaugh"
        self.author_email = "sahollib@gmail.com"
        self.copyright = "Copyright (c) 2009 Stephen Hollibaugh."
        ...
        self.extra_datas = ['bgTiles.bmp', 'enemy.bmp', 'flame.bmp', 'health.bmp', 'numbers.bmp', 'pickup.bmp', 'player.bmp', 'score.bmp', 'shot.bmp',
                            'explode.wav', 'shot1.wav', 'shot2.wav', 'shot3.wav']
